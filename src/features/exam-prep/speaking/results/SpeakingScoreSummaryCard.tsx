...
export function SpeakingScoreSummaryCard({ ui, engine }: { ui: SpeakingTrainingFeedbackUi; engine: ExamScoringEngineOutput }) {
  return (
    <Card variant="outlined" padding="md" className="border-primary-200/60 bg-primary-50/40">
      <p className="text-caption font-semibold text-primary-900 uppercase tracking-wide">Examen — spreken (training)</p>
