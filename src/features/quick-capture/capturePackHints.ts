 ...
 * Backend mirror: `backend/src/services/quick-capture/capturePackHints.ts`
 */
import { extractWordPackHints, type WordPackHints } from '@/features/quick-capture/wordRepPackHints'

export type PhrasePackHints = WordPackHints

/** Same JSON fields as words, but example lines suit multi-word phrases. */
