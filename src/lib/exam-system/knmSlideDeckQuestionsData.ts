...
export const KNM_SLIDE_DECK_QUESTION_ROWS: SlideDeckQuestionRow[] = [
  {
    ...
    audioScriptNl: 'Voor wie zijn sociale huurwoningen in Nederland bedoeld?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Wat is een urgentieverklaring bij sociale huur?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Huren in de vrije sector is in de regel…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Wat hoort in een huurcontract in Nederland vaak?',
  },
  {
    category: 'wonen_buurt',
    ...
    wrongs: [
      'Bij de politie voor elke huurvraag.',
      'Bij 112.',
      'Huurtoeslag bestaat niet in Nederland.',
    ],
    audioScriptNl: 'Waar vraag je huurtoeslag aan als de huur te hoog is voor je inkomen?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Om een huis te kopen hebben de meeste mensen…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Wat is renteaftrek bij een hypotheek?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Een aansprakelijkheidsverzekering dekt vooral…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Energie in huis regel je in Nederland meestal…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Je ruikt gas in huis. Wat is een verstandige eerste stap volgens de slides?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Waar zet je glas en papier volgens veel gemeenten?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Je zet huisafval op een verkeerde dag op straat. Wat kan er gebeuren?',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Harde muziek van buren: wat is meestal de eerste stap?',
  },
  {
    ...
    audioScriptNl: 'Waar kun je vacatures vinden volgens de slides?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Wat is een uitzendbureau?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Je bent ziek en kunt niet werken. Wat moet je volgens je contract vaak doen?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Wat is een WW-uitkering?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Wat staat er vaak in een arbeidscontract?',
  },
  {
    category: 'werk_inkomen',
    ...
    wrongs: [
      'Een paspoort.',
      'Een huisartsenpost.',
      'Een gemeentelijke vuilniszak.',
    ],
    audioScriptNl: 'Wat is een CAO?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Bruto salaris versus netto salaris: wat klopt?',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Discriminatie op het werk is in Nederland…',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'Wat doet de Kamer van Koophandel (KvK)?',
  },
  {
    ...
    audioScriptNl: 'Hoe begroeten veel Nederlanders elkaar informeel?',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Wanneer gebruik je vaak “u” in plaats van “jij”?',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Op Koningsdag vier je in Nederland vooral…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Wat gebeurt er op 4 mei in Nederland?',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      ...
      'Pasen alleen in de kerk.',
    ],
    audioScriptNl: 'Wat viert Nederland op 5 mei?',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      'In juli met oranje versiering.',
      'Alleen op het werk zonder traditie.',
      'Op 4 mei.',
    ],
    audioScriptNl: 'Sinterklaas wordt in Nederland vooral gevierd…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'In de rij bij de supermarkt vindt veel Nederlanders het vervelend als je…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Nederlandse directheid betekent in de omgang vaak…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Vrijheid van meningsuiting in de grondwet betekent…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Huiselijk geweld in Nederland is…',
  },
  {
    ...
    wrongs: [
      'Vanaf 16 jaar alleen.',
      'School is vrijwillig tot 25.',
      'Alleen in de vakantie.',
    ],
    audioScriptNl: 'Vanaf welke leeftijd is leerplicht in Nederland?',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    audioScriptNl: 'Wat doet het consultatiebureau?',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    wrongs: [
      'Alleen universiteit direct.',
      'Geen school meer.',
      'Alleen inburgering zonder onderwijs.',
    ],
    audioScriptNl: 'Na de basisschool gaan leerlingen meestal naar…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    wrongs: [
      '112.',
      'De politie voor elke rekening.',
      'Alleen op school zonder website.',
    ],
    audioScriptNl: 'Kinderopvangtoeslag vraag je aan via…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    wrongs: [
      'De sportschool.',
      'Je werkgever alleen voor vakantie.',
      'De apotheek.',
    ],
    audioScriptNl: 'Kinderbijslag ontvang je van…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    wrongs: [
      'De gemeente voor elk vak.',
      '112.',
      'Alleen contant zonder aanvraag.',
    ],
    audioScriptNl: 'Studiefinanciering na de middelbare school regel je via…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    wrongs: [
      '30 jaar.',
      'Alleen tot 5 jaar.',
      'Nooit; kinderen zijn altijd zelf verantwoordelijk.',
    ],
    audioScriptNl: 'Ouders zijn juridisch verantwoordelijk voor kinderen tot…',
  },
  {
    ...
    wrongs: [
      'Altijd 112.',
      'Alleen de tandarts voor koorts.',
      'De Belastingdienst.',
    ],
    audioScriptNl: 'Bij niet-spoedeisende klachten overdag ga je meestal eerst naar…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Medicijnen op recept haal je bij…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'De tandarts valt in Nederland…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Buiten kantooruren bel je voor huisartsenhulp vaak…',
  },
  {
    category: 'zorg_gezondheid',
  ...
  },
  {
    ...
    audioScriptNl: 'Iedereen die in Nederland woont moet hebben…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Wat is eigen risico bij de zorgverzekering?',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Zorgtoeslag is voor mensen met…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'De verloskundige helpt vooral bij…',
  },
  {
    ...
    audioScriptNl: 'Waar schrijf je je in als je in Nederland gaat wonen?',
  },
  {
    category: 'overheid_recht',
    ...
    wrongs: [
      'Elke bank zonder afspraak.',
      '112.',
      'De sportschool.',
    ],
    audioScriptNl: 'Paspoort of ID-kaart vraag je aan bij…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'DigiD gebruik je vooral om…',
  },
  {
    ...
    wrongs: [
      '30 jaar alleen.',
      'Geen ID nodig in Nederland.',
      'Alleen op Koningsdag.',
    ],
    audioScriptNl: 'Identificatieplicht geldt in Nederland vanaf…',
  },
  {
    category: 'veiligheid_hulp',
    ...
    audioScriptNl: 'Wat zijn drie taken van de politie volgens de slides?',
  },
  {
    category: 'veiligheid_hulp',
    ...
    wrongs: [
      '112 voor een verloren portemonnee zonder gevaar.',
      'De huisarts.',
      'DUO.',
    ],
    audioScriptNl: 'Voor niet-spoed meldingen bij de politie bel je vaak…',
  },
  {
    ...
    wrongs: [
      'Alleen een rijbewijs zonder nummer.',
      'Geen persoonlijk nummer.',
      'Alleen een KvK-nummer als kind.',
    ],
    audioScriptNl: 'Iedereen in Nederland heeft een…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'Belastingaangifte doen de meeste mensen…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'Welke toeslagen noemt de slide deck expliciet?',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'Bij bezwaar tegen een overheidsbesluit kun je gratis hulp krijgen van…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    wrongs: [
      ...
      '112 voor elk formulier.',
      'De GGD voor elke rechtszaak.',
    ],
    audioScriptNl: 'Juridisch advies voor burgers is o.a. te vinden bij…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'In Nederland is verplicht…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'Je bankpas is gestolen. Wat moet je eerst doen?',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'De grondwet noemt onder meer…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'De drie machten in Nederland zijn…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'De Tweede Kamer heeft hoeveel leden?',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'De Eerste Kamer heeft vooral de rol om…',
  },
  {
    category: 'overheid_recht',
    ...
    wrongs: [
      'Dictatuur zonder verkiezingen.',
      'Alleen een republiek zonder koning.',
      'Geen rechtsstaat.',
    ],
    audioScriptNl: 'Nederland is een…',
  },
  {
    category: 'overheid_recht',
    ...
    wrongs: [
      '12 jaar.',
      'Alleen in Den Haag wonend.',
      'Zonder identiteitsbewijs altijd.',
    ],
    audioScriptNl: 'Stemmen voor de Tweede Kamer mag je vanaf…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'De koning heeft vooral…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'Gemeenteraadsverkiezingen zijn…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'Nederland is lid van de Europese Unie. De EU maakt wetten voor o.a.…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Het Wilhelmus is het Nederlandse…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'De Tachtigjarige Oorlog eindigde in…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'De VOC was vooral…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'De Tweede Wereldoorlog in Nederland eindigde met bevrijding in…',
  },
  {
    category: 'integratie_cultuur',
    ...
    audioScriptNl: 'Na de watersnoodramp van 1953 kwam onder meer…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'De hoofdstad van Nederland is…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'De Randstad bestaat vooral uit…',
  },
  {
    category: 'wonen_buurt',
    ...
    wrongs: [
      'Spanje en Italië.',
      'Alleen Engeland over land.',
      'Frankrijk direct.',
    ],
    audioScriptNl: 'Nederland grenst aan…',
  },
  {
    category: 'wonen_buurt',
    ...
    wrongs: [
      'Een eiland in de Noordzee zonder land.',
      'De hoofdstad.',
      'Een bergketen.',
    ],
    audioScriptNl: 'Flevoland is vooral…',
  },
  {
    category: 'integratie_cultuur',
  ...
  },
  {
    ...
    wrongs: [
      'Alleen Engels.',
      'Duits overal verplicht.',
      'Frans.',
    ],
    audioScriptNl: 'De officiële taal van Nederland is…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      'De Deltawerken bouwen.',
      'Het ontwerp van de euro.',
      'De VOC oprichten.',
    ],
    audioScriptNl: 'Anne Frank is bekend van…',
  },
  {
    category: 'integratie_cultuur',
    ...
    good: 'Euro (€).',
    wrongs: [
      'Gulden alleen in Nederland.',
      'Dollar.',
      'Geen gemeenschappelijke munt.',
    ],
    audioScriptNl: 'Sinds 2002 gebruiken veel EU-landen de munt…',
  },
  {
    category: 'wonen_buurt',
    ...
    wrongs: [
      'Boven 3000 meter hoogte.',
      'In de woestijn.',
      'Op de maan.',
    ],
    audioScriptNl: '27% van Nederland ligt…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      'Koningsdag.',
      'Sinterklaas officieel.',
      'Alleen 4 mei.',
    ],
    audioScriptNl: 'Op 31 december en 1 januari vieren veel Nederlanders…',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'WIA-uitkering krijg je vooral als je…',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'AOW krijg je vanaf ongeveer…',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'De Arbo-wet gaat over…',
  },
  {
    category: 'werk_inkomen',
    ...
    audioScriptNl: 'De ondernemingsraad (OR) mag onder meer beslissen over…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      ...
      'Niets; kraamvisite bestaat niet.',
    ],
    audioScriptNl: 'Bij kraamvisite krijgen gasten vaak…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      ...
      'Via 112.',
      'Alleen online zonder gemeente.',
    ],
    audioScriptNl: 'Trouwen (formeel) in Nederland gebeurt meestal eerst…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'NPO 1, 2 en 3 zijn…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      'Moet je hard muziek draaien.',
      'Mag je alleen eten.',
      'Is praten verplicht.',
    ],
    audioScriptNl: 'In een stiltecoupé in de trein…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    audioScriptNl: 'Aan het einde van groep 8 op de basisschool…',
  },
  {
    category: 'onderwijs_opvoeding',
    ...
    audioScriptNl: 'VWO, HAVO en VMBO zijn…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Voor een SOA kun je ook terecht bij…',
  },
  {
    category: 'zorg_gezondheid',
    ...
    audioScriptNl: 'Huisartsen hebben beroepsgeheim. Dat betekent…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'Voor een permanente verblijfsvergunning moet je minstens…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    wrongs: [
      'Geen belasting.',
      'Alleen huurtoeslag.',
      'Alleen premie voor AOW.',
    ],
    audioScriptNl: 'Op veel producten in de winkel zit…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'Een acceptgiro gebruik je om…',
  },
  {
    category: 'geld_belasting_verzekering',
    ...
    audioScriptNl: 'Brandverzekering dekt vooral schade door…',
  },
  {
    category: 'overheid_recht',
    ...
    audioScriptNl: 'Een referendum is volgens de slides…',
  },
  {
    category: 'wonen_buurt',
    ...
    audioScriptNl: 'Het IJsselmeer en de Afsluitdijk…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      'Alleen België.',
      'De EU zonder Nederland.',
      'Duitsland.',
    ],
    audioScriptNl: 'Aruba, Curaçao en Sint-Maarten horen bij…',
  },
  {
    category: 'integratie_cultuur',
    ...
    wrongs: [
      ...
      'Niemand; het land is leeg.',
    ],
    audioScriptNl: 'In Nederland wonen ongeveer hoeveel mensen?',
  },
]

export const KNM_SLIDE_DECK_QUESTION_COUNT = 105
