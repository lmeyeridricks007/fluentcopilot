# Sub-feature: Pronunciation feedback UI
...
Display scores, tips, replay; gate by entitlement and consent.
...
- Feature flags: `pronunciation-feedback-ui` enablement, staged rollout percentage, kill switch.
...
- Analytics: `pronunciation-feedback-ui_started`, `pronunciation-feedback-ui_succeeded`, `pronunciation-feedback-ui_failed` (names illustrative—align with analytics catalog).
