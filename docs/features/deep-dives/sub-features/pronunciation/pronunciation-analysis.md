# Sub-feature: Pronunciation analysis
...
Send audio to pronunciation scoring API; normalize scores and tips.
...
- Feature flags: `pronunciation-analysis` enablement, staged rollout percentage, kill switch.
...
- Analytics: `pronunciation-analysis_started`, `pronunciation-analysis_succeeded`, `pronunciation-analysis_failed` (names illustrative—align with analytics catalog).
