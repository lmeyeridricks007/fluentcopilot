# Sub-feature: Pronunciation persistence

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: pronunciation-persistence  
**Parent deep-dive**: `docs/features/deep-dives/pronunciation.md`  
**Domain reference**: FD-06  
...
Store attempts and summaries per user with retention per BR-4.
...
- Feature flags: `pronunciation-persistence` enablement, staged rollout percentage, kill switch.
...
- Analytics: `pronunciation-persistence_started`, `pronunciation-persistence_succeeded`, `pronunciation-persistence_failed` (names illustrative—align with analytics catalog).
