# Sub-feature: Daily lesson delivery
...
Serve generated lesson through lesson runtime; completion + premium gate.
...
- Feature flags: `daily-lesson-delivery` enablement, staged rollout percentage, kill switch.
...
- Analytics: `daily-lesson-delivery_started`, `daily-lesson-delivery_succeeded`, `daily-lesson-delivery_failed` (names illustrative—align with analytics catalog).
