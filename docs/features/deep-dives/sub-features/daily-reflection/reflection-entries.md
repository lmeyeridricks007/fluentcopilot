# Sub-feature: Reflection entries
...
Create/list reflection entries with notes, optional photo, location; consent aware.
...
- Feature flags: `reflection-entries` enablement, staged rollout percentage, kill switch.
...
- Analytics: `reflection-entries_started`, `reflection-entries_succeeded`, `reflection-entries_failed` (names illustrative—align with analytics catalog).
