# Sub-feature: Reflection lesson generation

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: reflection-lesson-generation  
**Parent deep-dive**: `docs/features/deep-dives/daily-reflection.md`  
**Domain reference**: FD-07  
...
LLM generates lesson from entries + profile; moderation pipeline.
...
- Feature flags: `reflection-lesson-generation` enablement, staged rollout percentage, kill switch.
...
- Analytics: `reflection-lesson-generation_started`, `reflection-lesson-generation_succeeded`, `reflection-lesson-generation_failed` (names illustrative—align with analytics catalog).
