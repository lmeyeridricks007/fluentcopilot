# Sub-feature: Listening attempt

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: listening-attempt  
**Parent deep-dive**: `docs/features/deep-dives/listening-training.md`  
**Domain reference**: FD-05  
...
Load exercise audio and questions; hide transcript until attempt rules allow reveal.
...
- Feature flags: `listening-attempt` enablement, staged rollout percentage, kill switch.
...
- Analytics: `listening-attempt_started`, `listening-attempt_succeeded`, `listening-attempt_failed` (names illustrative—align with analytics catalog).
