...
Score answers; persist attempt; return feedback and optional transcript.
...
- Feature flags: `listening-scoring` enablement, staged rollout percentage, kill switch.
...
- Analytics: `listening-scoring_started`, `listening-scoring_succeeded`, `listening-scoring_failed` (names illustrative—align with analytics catalog).
