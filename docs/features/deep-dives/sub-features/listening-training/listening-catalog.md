...
Browse listening exercises by level/topic/exam; premium gating metadata.
...
- Feature flags: `listening-catalog` enablement, staged rollout percentage, kill switch.
...
- Analytics: `listening-catalog_started`, `listening-catalog_succeeded`, `listening-catalog_failed` (names illustrative—align with analytics catalog).
