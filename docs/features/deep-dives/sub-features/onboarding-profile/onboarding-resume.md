...
Partial save of onboarding; resume at last step; `onboarding_completed` flag gating main app.
...
- Feature flags: `onboarding-resume` enablement, staged rollout percentage, kill switch.
...
- Analytics: `onboarding-resume_started`, `onboarding-resume_succeeded`, `onboarding-resume_failed` (names illustrative—align with analytics catalog).
