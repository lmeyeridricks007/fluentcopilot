# Sub-feature: Consent management
...
**Domain reference**: FD-01 BFR-009  
...
Grant/withdraw consent for microphone, location, notifications, photo, AI context; persist per-type flags.
...
- Feature flags: `consent-management` enablement, staged rollout percentage, kill switch.
...
- Analytics: `consent-management_started`, `consent-management_succeeded`, `consent-management_failed` (names illustrative—align with analytics catalog).
