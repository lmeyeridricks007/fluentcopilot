# Sub-feature: First recommendation

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: first-recommendation  
**Parent deep-dive**: `docs/features/deep-dives/onboarding-and-profile.md`  
**Domain reference**: FD-01 FR-004  
...
Compute first/next lesson or path entry from profile + level; integrate with recommendations service.
...
- Feature flags: `first-recommendation` enablement, staged rollout percentage, kill switch.
...
- Analytics: `first-recommendation_started`, `first-recommendation_succeeded`, `first-recommendation_failed` (names illustrative—align with analytics catalog).
