...
Event-driven fan-out: streak, trial ending, daily lesson ready.
...
- Feature flags: `trigger-delivery` enablement, staged rollout percentage, kill switch.
...
- Analytics: `trigger-delivery_started`, `trigger-delivery_succeeded`, `trigger-delivery_failed` (names illustrative—align with analytics catalog).
