# Sub-feature: Notification settings

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: notification-settings  
**Parent deep-dive**: `docs/features/deep-dives/notifications.md`  
**Domain reference**: Notifications feature  
...
GET/PATCH preferences; marketing vs transactional; consent linkage.
...
- Feature flags: `notification-settings` enablement, staged rollout percentage, kill switch.
...
- Analytics: `notification-settings_started`, `notification-settings_succeeded`, `notification-settings_failed` (names illustrative—align with analytics catalog).
