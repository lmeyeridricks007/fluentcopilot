...
Track completion per component; aggregate dashboard metrics.
...
- Feature flags: `exam-progress` enablement, staged rollout percentage, kill switch.
...
- Analytics: `exam-progress_started`, `exam-progress_succeeded`, `exam-progress_failed` (names illustrative—align with analytics catalog).
