# Sub-feature: Simulated exam

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: simulated-exam  
**Parent deep-dive**: `docs/features/deep-dives/exam-preparation.md`  
**Domain reference**: FD-09  
...
Timed multi-task attempt; scoring breakdown; review mode.
...
- Feature flags: `simulated-exam` enablement, staged rollout percentage, kill switch.
...
- Analytics: `simulated-exam_started`, `simulated-exam_succeeded`, `simulated-exam_failed` (names illustrative—align with analytics catalog).
