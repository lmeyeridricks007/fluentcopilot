...
Task definitions, formats, level alignment, premium gates.
...
- Feature flags: `exam-tasks` enablement, staged rollout percentage, kill switch.
...
- Analytics: `exam-tasks_started`, `exam-tasks_succeeded`, `exam-tasks_failed` (names illustrative—align with analytics catalog).
