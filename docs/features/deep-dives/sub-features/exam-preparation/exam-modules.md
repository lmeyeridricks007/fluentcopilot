...
List exam types (A2/B1/KNM/ONA) and components; mapping to tasks.
...
- Feature flags: `exam-modules` enablement, staged rollout percentage, kill switch.
...
- Analytics: `exam-modules_started`, `exam-modules_succeeded`, `exam-modules_failed` (names illustrative—align with analytics catalog).
