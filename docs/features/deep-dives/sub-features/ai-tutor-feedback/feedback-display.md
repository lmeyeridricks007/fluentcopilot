...
Cards, disclaimers, practice CTAs; indicate AI-generated content.
...
- Feature flags: `feedback-display` enablement, staged rollout percentage, kill switch.
...
- Analytics: `feedback-display_started`, `feedback-display_succeeded`, `feedback-display_failed` (names illustrative—align with analytics catalog).
