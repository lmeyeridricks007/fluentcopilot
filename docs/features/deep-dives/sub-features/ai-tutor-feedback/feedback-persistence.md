# Sub-feature: Feedback persistence
...
Store feedback records linked to source activity; history API.
...
- Feature flags: `feedback-persistence` enablement, staged rollout percentage, kill switch.
...
- Analytics: `feedback-persistence_started`, `feedback-persistence_succeeded`, `feedback-persistence_failed` (names illustrative—align with analytics catalog).
