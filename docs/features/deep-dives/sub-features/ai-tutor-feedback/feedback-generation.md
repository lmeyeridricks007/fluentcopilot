# Sub-feature: Feedback generation

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: feedback-generation  
**Parent deep-dive**: `docs/features/deep-dives/ai-tutor-feedback.md`  
**Domain reference**: FD-11  
...
Aggregate session data; LLM/rule hybrid; categories; moderation (IS-016).
...
- Feature flags: `feedback-generation` enablement, staged rollout percentage, kill switch.
...
- Analytics: `feedback-generation_started`, `feedback-generation_succeeded`, `feedback-generation_failed` (names illustrative—align with analytics catalog).
