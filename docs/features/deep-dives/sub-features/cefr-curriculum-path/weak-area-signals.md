...
Aggregate mistakes by topic/skill from quizzes and exercises for recommendations.
...
- Feature flags: `weak-area-signals` enablement, staged rollout percentage, kill switch.
...
- Analytics: `weak-area-signals_started`, `weak-area-signals_succeeded`, `weak-area-signals_failed` (names illustrative—align with analytics catalog).
