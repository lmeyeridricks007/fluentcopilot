...
Short mixed exercises from completed lesson pools; template-based v1.
...
- Feature flags: `revision-sessions` enablement, staged rollout percentage, kill switch.
...
- Analytics: `revision-sessions_started`, `revision-sessions_succeeded`, `revision-sessions_failed` (names illustrative—align with analytics catalog).
