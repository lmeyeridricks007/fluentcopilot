# Sub-feature: Study level context

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: study-level-context  
**Parent deep-dive**: `docs/features/deep-dives/cefr-curriculum-path.md`  
**Domain reference**: Extension — see final/cefr-curriculum-path.md  
...
Distinguish `active_study_level` from self-assessment; settings UI and server validation against manifest.
...
- Feature flags: `study-level-context` enablement, staged rollout percentage, kill switch.
...
- Analytics: `study-level-context_started`, `study-level-context_succeeded`, `study-level-context_failed` (names illustrative—align with analytics catalog).
