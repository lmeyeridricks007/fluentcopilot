# Sub-feature: Daily learning plan
...
Daily queue for time/count goals; idempotent completion and streak integration.
...
- Feature flags: `daily-learning-plan` enablement, staged rollout percentage, kill switch.
...
- Analytics: `daily-learning-plan_started`, `daily-learning-plan_succeeded`, `daily-learning-plan_failed` (names illustrative—align with analytics catalog).
