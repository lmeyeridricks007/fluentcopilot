# Sub-feature: Voice completion

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: voice-completion  
**Parent deep-dive**: `docs/features/deep-dives/ai-voice-tutor.md`  
**Domain reference**: FD-04  
...
End session; pronunciation hooks optional; summary; XP; fair-use counters.
...
- Feature flags: `voice-completion` enablement, staged rollout percentage, kill switch.
...
- Analytics: `voice-completion_started`, `voice-completion_succeeded`, `voice-completion_failed` (names illustrative—align with analytics catalog).
