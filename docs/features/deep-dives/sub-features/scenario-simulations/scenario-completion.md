# Sub-feature: Scenario completion
...
End session; summary; XP/usage; feedback triggers (FD-11).
...
- Feature flags: `scenario-completion` enablement, staged rollout percentage, kill switch.
...
- Analytics: `scenario-completion_started`, `scenario-completion_succeeded`, `scenario-completion_failed` (names illustrative—align with analytics catalog).
