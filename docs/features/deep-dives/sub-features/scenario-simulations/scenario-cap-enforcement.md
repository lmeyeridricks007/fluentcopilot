# Sub-feature: Scenario cap enforcement

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: scenario-cap-enforcement  
**Parent deep-dive**: `docs/features/deep-dives/scenario-simulations.md`  
**Domain reference**: FD-03 + FD-12  
...
Free-tier periodic cap on scenario starts; consistent error contract with lesson caps.
...
- Feature flags: `scenario-cap-enforcement` enablement, staged rollout percentage, kill switch.
...
- Analytics: `scenario-cap-enforcement_started`, `scenario-cap-enforcement_succeeded`, `scenario-cap-enforcement_failed` (names illustrative—align with analytics catalog).
