...
Compute skill scores; weak/strong areas from activity signals.
...
- Feature flags: `skill-profile` enablement, staged rollout percentage, kill switch.
...
- Analytics: `skill-profile_started`, `skill-profile_succeeded`, `skill-profile_failed` (names illustrative—align with analytics catalog).
