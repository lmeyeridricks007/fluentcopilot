# Sub-feature: Activity ingestion
...
POST activity events; idempotent updates to progress and skill model.
...
- Feature flags: `activity-ingestion` enablement, staged rollout percentage, kill switch.
...
- Analytics: `activity-ingestion_started`, `activity-ingestion_succeeded`, `activity-ingestion_failed` (names illustrative—align with analytics catalog).
