...
Daily/weekly goals; progress tracking; optional generator.
...
- Feature flags: `learning-path` enablement, staged rollout percentage, kill switch.
...
- Analytics: `learning-path_started`, `learning-path_succeeded`, `learning-path_failed` (names illustrative—align with analytics catalog).
