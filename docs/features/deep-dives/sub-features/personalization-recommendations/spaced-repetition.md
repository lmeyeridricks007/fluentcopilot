...
Due items; recall logging; tie-in to flashcards/review.
...
- Feature flags: `spaced-repetition` enablement, staged rollout percentage, kill switch.
...
- Analytics: `spaced-repetition_started`, `spaced-repetition_succeeded`, `spaced-repetition_failed` (names illustrative—align with analytics catalog).
