# Sub-feature: Recommendations API

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: recommendations-api  
**Parent deep-dive**: `docs/features/deep-dives/personalization-and-recommendations.md`  
**Domain reference**: FD-14 cross-cutting  
...
GET recommendations and curated session sets (Continue, Daily, Scenario, etc.).
...
- Feature flags: `recommendations-api` enablement, staged rollout percentage, kill switch.
...
- Analytics: `recommendations-api_started`, `recommendations-api_succeeded`, `recommendations-api_failed` (names illustrative—align with analytics catalog).
