...
Forgot-password request, token issuance, secure reset page, and audit logging; throttle abuse.
...
- Feature flags: `password-reset` enablement, staged rollout percentage, kill switch.
...
- Analytics: `password-reset_started`, `password-reset_succeeded`, `password-reset_failed` (names illustrative—align with analytics catalog).
