# Sub-feature: OAuth integration

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: oauth-integration  
**Parent deep-dive**: `docs/features/deep-dives/authentication.md`  
**Domain reference**: Authentication  
...
Provider redirect URLs, callback handling, account linking, and error mapping for social login.
...
- Feature flags: `oauth-integration` enablement, staged rollout percentage, kill switch.
...
- Analytics: `oauth-integration_started`, `oauth-integration_succeeded`, `oauth-integration_failed` (names illustrative—align with analytics catalog).
