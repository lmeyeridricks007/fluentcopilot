# Sub-feature: Location consent

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: location-consent  
**Parent deep-dive**: `docs/features/deep-dives/location-aware-prompts.md`  
**Domain reference**: FD-08  
...
Enable/disable feature; map to BR-3; tie to OS permission prompts.
...
- Feature flags: `location-consent` enablement, staged rollout percentage, kill switch.
...
- Analytics: `location-consent_started`, `location-consent_succeeded`, `location-consent_failed` (names illustrative—align with analytics catalog).
