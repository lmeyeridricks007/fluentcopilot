# Sub-feature: Gamification summary
...
API for home/profile: XP, streak, achievements snapshot.
...
- Feature flags: `gamification-summary` enablement, staged rollout percentage, kill switch.
...
- Analytics: `gamification-summary_started`, `gamification-summary_succeeded`, `gamification-summary_failed` (names illustrative—align with analytics catalog).
