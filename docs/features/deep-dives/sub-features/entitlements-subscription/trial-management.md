...
Start/end trial; `trial_ends_at`; downgrade to free; messaging.
...
- Feature flags: `trial-management` enablement, staged rollout percentage, kill switch.
...
- Analytics: `trial-management_started`, `trial-management_succeeded`, `trial-management_failed` (names illustrative—align with analytics catalog).
