...
Central policy comparing usage to caps; stable 403 codes; product config.
...
- Feature flags: `cap-enforcement` enablement, staged rollout percentage, kill switch.
...
- Analytics: `cap-enforcement_started`, `cap-enforcement_succeeded`, `cap-enforcement_failed` (names illustrative—align with analytics catalog).
