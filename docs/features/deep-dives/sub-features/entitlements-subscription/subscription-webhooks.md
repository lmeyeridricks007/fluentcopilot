# Sub-feature: Subscription webhooks

**Feature**: See folder and `docs/features/deep-dives/feature-index.md`  
**Sub-feature**: subscription-webhooks  
**Parent deep-dive**: `docs/features/deep-dives/entitlements-and-subscription.md`  
**Domain reference**: FD-12  
...
Idempotent handling of payment provider events; subscription state machine.
...
- Feature flags: `subscription-webhooks` enablement, staged rollout percentage, kill switch.
...
- Analytics: `subscription-webhooks_started`, `subscription-webhooks_succeeded`, `subscription-webhooks_failed` (names illustrative—align with analytics catalog).
