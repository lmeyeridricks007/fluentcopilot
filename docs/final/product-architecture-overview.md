...
| Status | **Final** |
| Source | product-architecture-overview-v2.md; audit passed |
...
| **Lesson Engine** | Content selection, learning path, lessons, flashcards, quizzes, scenarios (orchestration); content from PostgreSQL and/or CMS (see Data doc) | PostgreSQL, Redis | CDN (media) |
