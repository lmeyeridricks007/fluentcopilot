...
| Status | **Final** |
| Source | business-requirements-v2.md; audit passed |
...
| BFR-013 | The system shall support conversion funnel analytics (trial start, trial end, payment success, churn) for optimization. |
